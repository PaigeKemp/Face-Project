...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/paigekemp/Desktop/UNCG/UNCG Research/Current Experiments/OtherRaceEffect/OtherRaceEffect_Program.py',
...
for thisBlock1 in Block1:
    ...
    B1_Trial = data.TrialHandler(nReps=1, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('B1' + condition + '.xlsx'),
